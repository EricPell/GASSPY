...
def coordinate_transform(ray_df, rotation_matrix, ray_parameters_df):
    ...
    ray_df["xi"] = cupy.full(len(ray_df), ray_parameters_df["xp0_r"].iloc[0] * float(rotation_matrix[0][0]) + 
                                          ...
                                          ray_parameters_df["zp0_r"].iloc[0] * float(rotation_matrix[0][2]) + ray_parameters_df["rot_origin_x"].iloc[0])
    ...
    ray_df["yi"] = cupy.full(len(ray_df), ray_parameters_df["xp0_r"].iloc[0] * float(rotation_matrix[1][0]) + 
                                          ...
                                          ray_parameters_df["zp0_r"].iloc[0] * float(rotation_matrix[1][2]) + ray_parameters_df["rot_origin_y"].iloc[0])
    ...
    ray_df["zi"] = cupy.full(len(ray_df), ray_parameters_df["xp0_r"].iloc[0] * float(rotation_matrix[2][0]) + 
                                          ...
                                          ray_parameters_df["zp0_r"].iloc[0] * float(rotation_matrix[2][2]) + ray_parameters_df["rot_origin_z"].iloc[0])
    ...
    #                 ((ray_df["zp"] + ray_parameters_df["zp0_r"].iloc[0])*float(rotation_matrix[1][2])) + ray_parameters_df["rot_origin_y"].iloc[0])
    # ray_df["yi"] = ray_df["yi"].astype(int)
    ...
    #                 ((ray_df["zp"] + ray_parameters_df["zp0_r"].iloc[0])*float(rotation_matrix[2][2])) + ray_parameters_df["rot_origin_z"].iloc[0])
    # ray_df["zi"] = ray_df["zi"].astype(int)
